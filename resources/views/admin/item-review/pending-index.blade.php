                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter table-striped card-table">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center">No Pending Items Found</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
