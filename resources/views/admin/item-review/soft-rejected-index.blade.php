...
@section('title', 'Soft Rejected Items')
            ...
            <div class="container-xl">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="card-title">Soft Rejected Items</h3>
                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter table-striped card-table">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center">No Soft Rejected Items Found</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
