            ...
            <div class="container-xl">
                <div class="card">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <x-admin.input-text name="file_types" :label="__('File Types')" data-role="tagsinput"
                                        placeholder="ZIP, MP4, MP3, PNG" :value="implode(',', $category->file_types)" :hint="__('Allowed files for upload as main file')" />
                                </div>
                    ...
                    <div class="card-footer text-end">
                        <x-admin.submit-button :label="__('Update')" onclick="submitCategoryForm(this)" />
                    </div>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Show current icon initially
            if (iconInput.value) {
                preview.innerHTML = `<i class="${iconInput.value}" style="font-size:24px;"></i>`;
            }
