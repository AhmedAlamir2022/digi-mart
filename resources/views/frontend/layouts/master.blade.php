...
<body>
    ...
    <div class="preloader_area">
        <div class="preloader_img">
            <img src="{{ asset('frontend/images/thumbs/preloader.gif') }}" alt="Preloader">
        </div>
    </div>
    <!--==================== Preloader End ====================-->
    ...
    <!-- apex chart -->
    <script src="{{ asset('frontend/js/apexchart.js') }}"></script>
    <!-- marquee -->
    <script src="{{ asset('frontend/js/marquee.min.js') }}"></script>
    <!-- infinite slide  -->
    <script src="{{ asset('frontend/js/infiniteslidev2.js') }}"></script>
    <!-- select 2  -->
    ...
    <!-- global js variables -->
    <script src="{{ asset('frontend/js/default/default-variables.js') }}"></script>

    <!-- cart js -->
    <script src="{{ asset('frontend/js/default/cart.js') }}"></script>
