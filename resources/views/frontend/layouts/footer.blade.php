{{-- @php
    ...
    $customPages = App\Models\CustomPage::where(['status' => 1])
        ...
        ->get();
@endphp --}}
<footer class="footer-section " style="background: url({{ asset('frontend/images/shapes/footer-bg.png') }});">
    <div class="container">
        <div class="subscription pt_55 pb_45"
            style="background: url({{ asset('frontend/images/thumbs/subscrib_bg.jpg') }});">
