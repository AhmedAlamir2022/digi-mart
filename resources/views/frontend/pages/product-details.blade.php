                    ...
                    <div class="wsus__product_details_text">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                                ...
                                @else
                                    <div class="text-center alert alert-info">{{ __('You need to login to review') }}
                                    </div>
                                @endif
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="wsus__sidebar pl_30 xs_pl_0" id="sticky_sidebar">
                        <div class="wsus__sidebar_licence">
                            ...
                            <h2><span>{{ config('settings.currency_icon') }}</span>
                                {{ $product->discount_price > 0 ? $product->discount_price : $product->price }}</h2>
                            <ul class="feature">
                            ...
                            <ul class="button_area d-flex flex-wrap">
                                ...
                                @endif
                                <li class="text-center"><a class="add_cart add-cart mb-3" data-id="{{ $product->id }}"
                                        href="javascript:;">add to cart</a></li>
                            </ul>
